...
A tool to get a and r in an arithmetic series, and then find specific terms in the series.
Dec. 4 2018
*/
#include <iostream>
#include <cmath>
...
long double getTerm(double n, double a, double d) {
  return (a + (n - 1) * d);
}
long double getSum(double n, double a, double d) {
...
int main(int argc, char* argv[]) {
  ...
  if (argc < 3) {
    ...
    std::cout << "geometricSeries -m <a> <d>" << std::endl;
